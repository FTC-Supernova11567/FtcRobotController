...
public class redrightauto1 {
    ...
    public class redleftauto1 {
        ...
        @TeleOp(name = "AutoDriveByTrajectory1", group = "Iterative OpMode")
        @Disabled
        public class AutoDriveByTrajectory1 extends OpMode {
            ...
            public void start() {
                runtime.reset();
                drive.followTrajectory(bluebottombackup);
            }
